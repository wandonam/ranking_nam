...
# ================= 설정 =================
BASE_DB = Path('../data/raw')
OUTPUT_PATH = Path('../data/report')

PLATFORMS = {
    'naver':      {'dir': 'naver',      'diff_cols': ['price', 'review', 'rank', 'star']},
    'coupang':    {'dir': 'coupang',    'diff_cols': ['price', 'review', 'rank', 'star']},
    'oliveyoung': {'dir': 'oliveyoung', 'diff_cols': ['price', 'rank']},
    'kakao':      {'dir': 'kakao',      'diff_cols': ['price', 'rank', 'like']},
    'daiso':      {'dir': 'daiso',      'diff_cols': ['price', 'review', 'rank', 'star']},
}
